...
* Serial Monitor configured to correct baud rate.
* Commands ?, l, and o function correctly.
* LED responds to serial commands.
* DEBUG mode tested.
* Uptime messages displayed every 2 seconds.
* No long blocking delays present.
* DEBUGGING.md completed.
* Changes committed to branch day-04-serial-debug.
